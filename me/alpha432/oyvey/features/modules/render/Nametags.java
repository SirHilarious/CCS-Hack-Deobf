...
public class Nametags extends Module
{
    ...
    public Nametags() {
        ...
        this.inside = (Setting<Boolean>)this.register(new Setting("Background", (T)true));
        this.outlineMode = (Setting<OutLineMode>)this.register(new Setting("Outline Mode", (T)OutLineMode.DEPEND));
        this.Ored = (Setting<Integer>)this.register(new Setting("Outline Red", (T)0, (T)0, (T)255, v -> this.outline.getValue() && this.outlineMode.getValue() == OutLineMode.NORMAL));
        this.Ogreen = (Setting<Integer>)this.register(new Setting("Outline Green", (T)0, (T)0, (T)255, v -> this.outline.getValue() && this.outlineMode.getValue() == OutLineMode.NORMAL));
        this.Oblue = (Setting<Integer>)this.register(new Setting("Outline Blue", (T)0, (T)0, (T)255, v -> this.outline.getValue() && this.outlineMode.getValue() == OutLineMode.NORMAL));
        this.Oalpha = (Setting<Integer>)this.register(new Setting("Outline Alpha", (T)155, (T)0, (T)255, v -> this.outline.getValue()));
        this.Owidth = (Setting<Float>)this.register(new Setting("Outline Width", (T)1.5f, (T)0.0f, (T)3.0f, v -> this.outline.getValue()));
        this.reversed = (Setting<Boolean>)this.register(new Setting("Reversed", (T)false));
        this.reversedHand = (Setting<Boolean>)this.register(new Setting("Reversed Hand", (T)false));
        this.enchantMode = (Setting<EnchantMode>)this.register(new Setting("Enchant Mode", (T)EnchantMode.MAX));
        ...
        this.pingColor = (Setting<Boolean>)this.register(new Setting("Ping Color", (T)true));
        this.armor = (Setting<Boolean>)this.register(new Setting("Armor", (T)true));
        this.durability = (Setting<Boolean>)this.register(new Setting("Durability", (T)true));
        this.item = (Setting<Boolean>)this.register(new Setting("Item Name", (T)true));
        this.invisibles = (Setting<Boolean>)this.register(new Setting("Invisibles", (T)false));
        this.pops = (Setting<Boolean>)this.register(new Setting("Pop Count", (T)true));
        ...
        this.friendMode = (Setting<FriendMode>)this.register(new Setting("Friend Mode", (T)FriendMode.TEXT, v -> this.friends.getValue()));
        this.red = (Setting<Integer>)this.register(new Setting("Friend Red", (T)0, (T)0, (T)255, v -> this.friends.getValue()));
        this.green = (Setting<Integer>)this.register(new Setting("Friend Green", (T)130, (T)0, (T)255, v -> this.friends.getValue()));
        this.blue = (Setting<Integer>)this.register(new Setting("Friend Blue", (T)130, (T)0, (T)255, v -> this.friends.getValue()));
    }
