...
public class Offhand extends Module
{
    ...
    public Setting<Boolean> requireSword;
    ...
    public Offhand() {
        ...
        this.requireSword = (Setting<Boolean>)this.register(new Setting("RequireSword", (T)false));
    ...
    public void doSwitch() {
        ...
        if (this.gapple.getValue() && Offhand.mc.player.getHeldItemMainhand().getItem() instanceof ItemSword && Offhand.mc.gameSettings.keyBindUseItem.isKeyDown()) {
            if (!this.requireSword.getValue() || Offhand.mc.player.getHeldItemMainhand().getItem() instanceof ItemSword) {
